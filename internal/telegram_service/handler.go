...
func (api *APIBot) initHandlers() {
	...
	api.bh.Handle(handlers.TitleClassicFsm(api.cfg, api.log, api.fsm), handlers.ClassicFsmPredicate("start", api.fsm))
	api.bh.Handle(handlers.PhotoClassicFsm(api.cfg, api.log, api.fsm), handlers.ClassicFsmPredicate("title_set", api.fsm))
	api.bh.Handle(handlers.EmojiClassicFsm(api.cfg, api.log, api.fsm), handlers.ClassicFsmPredicate("photo_set", api.fsm))
